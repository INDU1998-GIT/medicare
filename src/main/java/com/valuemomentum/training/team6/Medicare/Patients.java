	     ...
	     void newPatient() {
		        try {
		            ...
		            String h=s.next();
		             ...
		             stmt=con.prepareStatement("insert into patients(pfname,plname,age,disease,city,gender,pmobileno,d_id,pemailid,reports) values(?,?,?,?,?,?,?,?,?,?)");
		    ...
		    void ExistingPatients() {
				try {
					  ...
					  int P_id=s.nextInt();
					  String query = "select P_id,pfname,plname,age,disease,city,gender,pmobileno,d_id,pemailid,reports from Patients where P_id = ?";
	...
	// System.out.println("Existing patient details are displayed");
		    ...
		    void DisplayPatient() {
		        try {
		  			...
		  			rs=smt.executeQuery("select P_id,pfname,plname,age,disease,city,gender,pmobileno,d_id,pemailid,reports from patients");
